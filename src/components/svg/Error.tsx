...
const Loader: React.FC<{ fill?: string; width?: string; height?: string }> = ({ fill = "#008000", width, height }) => {
    return (
        <Wrapper xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24">
            <path
                fill={fill}
